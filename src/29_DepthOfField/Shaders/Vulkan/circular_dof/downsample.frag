...
void main()
{
	...
	float cocFar00 = clamp(texture(sampler2D(TextureCoC, samplerPoint), texCoord00).g * 5, 0.0f, 1.0f);
	float cocFar10 = clamp(texture(sampler2D(TextureCoC, samplerPoint), texCoord10).g * 5, 0.0f, 1.0f);
	float cocFar01 = clamp(texture(sampler2D(TextureCoC, samplerPoint), texCoord01).g * 5, 0.0f, 1.0f);
	float cocFar11 = clamp(texture(sampler2D(TextureCoC, samplerPoint), texCoord11).g * 5, 0.0f, 1.0f);
